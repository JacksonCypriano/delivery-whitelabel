def build_prospecting_message(establishment: str) -> str:
    ...
    return (
        ...
        "O plano custa R$ 199 por mês, sem comissão sobre os pedidos. Estou enviando uma apresentação com todos os recursos, "
        "condições e o acesso à nossa loja demonstrativa, para vocês testarem diretamente pelo celular.\n\n"
        f"Se tiver interesse em colocar {second_reference} no VemDeDelivery, responda a esta mensagem e eu envio as orientações para começarmos.\n\n"
        "Jackson Cypriano\n"
