(function () {
    ...
    modal.innerHTML = '' +
      '<div style="width:min(680px,100%);max-height:90vh;overflow:auto;border-radius:18px;background:#fff;color:#173f35;box-shadow:0 24px 80px rgba(15,23,42,.28);padding:28px;">' +
        ...
        '<ul style="margin:0 0 18px;padding-left:22px;line-height:1.6;">' +
          ...
          '<li>Após a aprovação do cadastro pelo Asaas, a plataforma confirmará o status e a opção de recebimento online aparecerá automaticamente para a loja. Até essa confirmação, o recebimento pessoal continua disponível.</li>' +
  ...
  function initializeRow(row) {
    ...
    if (!button) {
      ...
      note.textContent = 'Abra o aviso para consultar as condições e taxas do Asaas.';
