...
PROSPECTING_EVOLUTION_AUTO_RECONNECT = os.getenv("PROSPECTING_EVOLUTION_AUTO_RECONNECT", "true").lower() in ("1", "true", "yes", "on")
PROSPECTING_EVOLUTION_RECONNECT_WAIT_SECONDS = float(os.getenv("PROSPECTING_EVOLUTION_RECONNECT_WAIT_SECONDS", "10"))
PROSPECTING_EVOLUTION_ACK_TIMEOUT = float(os.getenv("PROSPECTING_EVOLUTION_ACK_TIMEOUT", "5"))
